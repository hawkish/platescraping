...
import Utils (following, getElementAt, getTagTexts)
import Data.Maybe
...
getFollowingText :: T.Text -> T.Text -> Maybe T.Text
getFollowingText a b = following a inText
                       where inText = getTagTexts b
